...
void dpsifn(double x, int n, int kode, int m, double *ans, int *nz, int *ierr)
{
    ...
    double arg, den, eps, fx, rxsq, s, t, ta, tk, tol, tols, tss, tst, tt, t1, t2, xdmln, xdmy, xinc, xm, xmin, xq;
    ...
    *nz = 0;
    ...
    const double r1m5 = Rf_d1mach(5), // = M_LOG10_2 = log10(2) = 0.30103..
    ...
    const double rln = fmin2(r1m5 * Rf_i1mach(14), 18.06); // = 0.30103 * 53 = 15.95.. ~= #{decimals}
