...
long WINAPI edit_control_procedure(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    int key;
    object obj, next;
    HANDLE hwndCombo;
...
void init_events(void)
{
    ...
    edit_control_proc = (WNDPROC)MakeProcInstance((FARPROC)edit_control_procedure, this_instance);
}
