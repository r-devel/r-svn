...
SEXP ALTOPAQUE_FORMAT(SEXP x, R_xlen_t i, R_xlen_t n);
int ALTOPAQUE_COMPARE(SEXP x, R_xlen_t i, SEXP y, R_xlen_t j);
SEXP ALTOPAQUE_ARITH(SEXP call, SEXP op, SEXP x, SEXP y);
SEXP ALTOPAQUE_RELOP(SEXP call, SEXP op, SEXP x, SEXP y);
