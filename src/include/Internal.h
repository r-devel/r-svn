...
SEXP do_xinteger(SEXP, SEXP, SEXP, SEXP);
SEXP do_asxinteger(SEXP, SEXP, SEXP, SEXP);
SEXP do_xintegerraw(SEXP, SEXP, SEXP, SEXP);
SEXP do_xintegeris(SEXP, SEXP, SEXP, SEXP);
SEXP do_xintegerhasna(SEXP, SEXP, SEXP, SEXP);
SEXP do_xintegerkind(SEXP, SEXP, SEXP, SEXP);
SEXP do_xintegerwidth(SEXP, SEXP, SEXP, SEXP);
