...
checkDollarSuggestions("arith_named_env$a", c("`abc+def`", "`abc-def`"))
checkDollarSuggestions("arith_named_env$def", c("`def-abc`", "defabc"))
checkDollarSuggestions("arith_named_env$", c("`abc+def`", "`def-abc`", "`abc-def`", "defabc"))
rm(arith_named_env)
