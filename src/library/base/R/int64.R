#  File src/library/base/R/int64.R
...
## `na = FALSE` builds a vector whose domain excludes NA, so the whole
## 64-bit range is available for data.  That is what a column read from a
## source with no concept of a missing value wants.
